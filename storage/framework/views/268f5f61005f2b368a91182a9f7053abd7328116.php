...
<div class="container panel panel-default ">
        ...
        <div class="form-group">
            <b><span class="text-success" id="success-message"> </span><
                b>
        </div>
        </form>
       ...
       $('#kyc').on('#submit',function(event){
           ...
           $.ajax({
               ...
               success:function(response){
                ...
                errors:function(response){
                    ...
                    $('#id_number-error').text(response.responseJSON.errors.id_number);                   
        ...
        </html><?php /**PATH /home/steve/singlepage-app/resources/views/kyc.blade.php ENDPATH**/ ?>