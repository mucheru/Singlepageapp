    ...
    <div class="row">
        <div class="col-12">
          <table class="table table-bordered" id="">
           ...
           <tbody id="users-crud">
              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr id="user_id_<?php echo e($u_info->id); ?>">
                 <td><?php echo e($u_info->id); ?></td>
                 <td><?php echo e($u_info->f_name); ?></td>
                 <td><?php echo e($u_info->m_name); ?></td>
                 <td><?php echo e($u_info->l_name); ?></td>
                 <td><?php echo e($u_info->id_number); ?></td>

                 <td><a href="javascript:void(0)" id="show-user" data-id="<?php echo e($u_info->id); ?>" class="btn btn-info">Show</a></td>
              </tr>
...
<?php /**PATH /home/steve/singlepage-app/resources/views/getkyc.blade.php ENDPATH**/ ?>